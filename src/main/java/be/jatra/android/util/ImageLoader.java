...
public abstract class ImageLoader {
    ...
    public static void cancelWork(ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (BuildConfig.DEBUG) {
                ...
                LOGGER.debug("cancelWork - cancelled work for " + bitmapData);
            }
        }
    }
    ...
    public static boolean cancelPotentialWork(Object data, ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (bitmapData == null || !bitmapData.equals(data)) {
                bitmapWorkerTask.cancel(true);
                if (BuildConfig.DEBUG) {
                    LOGGER.debug("cancelPotentialWork - cancelled work for " + data);
                }
            } else {
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... params) {
            if (BuildConfig.DEBUG) {
                LOGGER.debug("doInBackground - starting work");
            }
            ...
            if (BuildConfig.DEBUG) {
                LOGGER.debug("doInBackground - finished work");
            }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap != null && imageView != null) {
                if (BuildConfig.DEBUG) {
                    LOGGER.debug("onPostExecute - setting bitmap");
                }
    ...
    private void setImageBitmap(ImageView imageView, Bitmap bitmap) {
        if (mFadeInBitmap) {
            int transparant = imageView.getResources().getColor(android.R.color.transparent);
            // Transition drawable to fade from loading bitmap to final bitmap
            final TransitionDrawable td =
                    new TransitionDrawable(new Drawable[]{
                            new ColorDrawable(transparant),
